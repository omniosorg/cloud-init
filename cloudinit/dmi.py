...
kdmi = namedtuple("KernelNames", ["linux", "freebsd", "illumos"])
kdmi.__new__.defaults__ = (None, None, None)
...
DMIDECODE_TO_KERNEL = {
    "baseboard-asset-tag": kdmi("board_asset_tag", "smbios.planar.tag", None),
